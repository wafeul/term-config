...
if initialize_session "xtals"; then
    ...
    new_window "xtals-compose"
    run_cmd "vi crystals-compose.yml"
    window_root "~/Projects/CRIMS/PHP_update/docker-build/logs/crystal-manager"
    new_window "Log-xtals"
    run_cmd "tail -f laravel-${date}.log"
    window_root "~/Projects/CRIMS/PHP_update/docker-build/logs"
    new_window "Log-"
    window_root "~/Projects/CRIMS/PHP_update/api_volumes/crystal-manager-new/crystalmanager/laravel"
    new_window "NVIM XTALS"
    run_cmd "vi"
    window_root "~/Projects/CRIMS/PHP_update/api_volumes/crystal-manager-new/crystalmanager/laravel"
    new_window "BASH XTALS"
    window_root "~/Projects/CRIMS/PHP_update/api_volumes/crystal-manager-new/crystalmanager/laravel"
    new_window "DB XTALS"
